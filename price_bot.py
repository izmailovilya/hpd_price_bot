...
def usdt(message):
    bot.send_message(message.chat.id, f'Курс USDT на Binance: {rates.get_usdt_rate() - 1:.2f}')
...
def checker(message):
    bot.send_message(message.chat.id, 'Пришлите мне 2 сообщения со списком переводов')
